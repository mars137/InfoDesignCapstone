...
console.log("inside functionlityu");
 ...
 if(newValue==3)
  ...
  app.controller("retriveCtrl",['$rootScope','$scope','$http','$filter',function($rootScope,$scope,$http,$filter){
...
//user.due_date=new Date(doo.getTime()+doo.getTimezoneOffset()*60000);
 ...
 $http.post('http://localhost:8080/editstatus/', p)
  ...
  app.controller("assign", ['$rootScope','$scope','$http',function($rootScope,$scope,$http) {
    var lastVal="";
    var p;
